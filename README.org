...
all your command line parsing needs. Here I'll just show you how we'll use it
...
(bb-cli/parse-opts ["-e" "The toast had eyes :("] bb-cli-opts)
;; =>
{:entry "The toast had eyes :("}

;; leaving out a required flag throws an exception:
(bb-cli/parse-opts [] bb-cli-opts)

...
The broader Clojure ecosystem provides two libraries for handling argument
parsing:

- [[https://github.com/clojure/tools.cli][clojure.tools.cli]]
- [[https://github.com/nubank/docopt.clj][nubank/docopt.clj]]

Babashka gives you an additional tool, the task system, that handles both
dispatching and parsing. We'll look at clojure.tools.cli and tasks.

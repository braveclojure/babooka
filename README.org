...
If you'd like to stop doing something that hurt (writing incomprehensible shell
...
you'd typically used bash, ruby, python, and the like. From a CLI, you can run
something like the following to immediately execute your Clojure program:

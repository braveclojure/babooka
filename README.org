...
With this code we can add an entry by calling ~./journal "Flying!! But also
naked :/"~. This gets us part of the way to our goal; we want to the interface
to be ~./journal add "entry text"~

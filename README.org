...
You read somewhere that source files should be AT MOST 50 lines long, so you
decide that you want to put this list functionality in its own file. How do you
do that?
